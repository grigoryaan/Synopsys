...
constexpr int MEM_TOTAL   = 64 * 1024;

constexpr int CODE_BASE   = 0x0000;
constexpr int CODE_SIZE   = 0x4000;
constexpr int DATA_BASE   = 0x4000;
constexpr int DATA_SIZE   = 0x4000;
constexpr int STACK_BASE  = 0x8000;
constexpr int STACK_SIZE  = 0x4000;
